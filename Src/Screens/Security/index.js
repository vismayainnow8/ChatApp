        ...
        <View style={styles.detailedlistItemContainer}>
          <View style={styles.detailednameContainer}>
            <Text style={styles.nameText}>
              This app secures your conversations with end-to-end
              encryption.This means your messages ,calls, and status updates
              stay between you and the people you choose.Not even this apppp can
        ...
        <View style={styles.detailedlistItemContainer}>
          <View style={styles.detailednameContainer}>
            <Text style={styles.statusText}>
              Turn on this setting to recievenotifications when one of your
