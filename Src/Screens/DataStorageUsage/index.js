        ...
        return (
                ...
                <ScrollView style={styles.mainContainer}>
                        ...
                        <View style={styles.contentContainer}>
                                ...
                                <Text style={styles.statusText}>Voice messages are always auto-downloaded for best communication experience</Text>
                                ...
                                <View style={[styles.detailedlistItemContainer, { flexDirection: "row" }]}>
                                        <View style={styles.detailedcallerDetailsContainer}>
                                                <View style={styles.callerDetailsContainerWrap}>
                                                        <View style={styles.detailednameContainer}>
                                                                <Text style={styles.nameText}>Low data usage</Text>
                                                                <Text style={styles.statusText}>Reduce the data used in the call</Text>
                                                        </View>
