...
const Notifications = ({ navigation }) => {
        useLayoutEffect(() => {
                navigation.setOptions({
                        ...
                        headerRight: () => {
                                return <IconEntypo onPress={() => alert('search')} name="dots-three-vertical" size={24} color="white" style={{ paddingRight: 10 }} />
                        ...
                        <View style={styles.contentContainer}>
                                ...
                                <View style={styles.detailedlistItemContainer}>
                                        <View style={styles.detailednameContainer}>
                                                ...
                                                <Text style={styles.statusText}>Play sounds for incoming and outgoing messages</Text>
                                        </View>
                                ...
                                <View style={styles.detailedlistItemContainer}>
                                        <View style={styles.detailednameContainer}>
                                                ...
                                                <Text style={styles.statusText}>Default ringtone (lava doorbell)</Text>
                                        </View>
                                </View>
                                ...
                                <View style={styles.detailedlistItemContainer}>
                                        <View style={styles.detailednameContainer}>
                                                ...
                                                <Text style={styles.statusText}>Show previews of notification at the top of the screen</Text>
                                        </View>
                                        <View style={styles.detailediconContainer}>
                                                {/* <IconAntDesign name="questioncircle" color="grey" size={23} style={{ padding: 5 }} /> */}
                                                <Switch
