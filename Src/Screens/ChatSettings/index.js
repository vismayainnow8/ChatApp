                        ...
                        <View style={styles.contentContainer}>
                                ...
                                <View style={styles.detailedlistItemContainer}>
                                        <View style={styles.detailediconContainer}>
                                                <IconMaterialIcons name="brightness-6" color="#075e54" size={23} style={{ padding: 5 }} />
                                        </View>
                                ...
                                <View style={styles.detailedlistItemContainer}>
                                        ...
                                        <View style={styles.detailedcallerDetailsContainer}>
                                                ...
                                                <Text style={styles.statusText}>Enter key will send your message</Text>
                                        </View>
                                        <View style={styles.detailediconContainer}>
                                                {/* <IconAntDesign name="questioncircle" color="grey" size={23} style={{ padding: 5 }} /> */}
                                                <Switch
                                ...
                                <View style={styles.detailedlistItemContainer}>
                                        ...
                                        <View style={styles.detailedcallerDetailsContainer}>
                                                ...
                                                <Text style={styles.statusText}>Show newly downloaded media in your phone's gallery</Text>
                                        </View>
                                        <View style={styles.detailediconContainer}>
                                                {/* <IconAntDesign name="questioncircle" color="grey" size={23} style={{ padding: 5 }} /> */}
                                                <Switch
                                ...
                                <View style={styles.detailedlistItemContainer}>
                                        <View style={styles.detailediconContainer}>
                                                <IconMaterialIcons name="backup" color="#075e54" size={23} style={{ padding: 5 }} />
                                        </View>
                                        <View style={styles.detailedcallerDetailsContainer}>
                                ...
                                <View style={styles.detailedlistItemContainer}>
                                        <View style={styles.detailediconContainer}>
                                                <IconMaterialIcons name="history" color="#075e54" size={23} style={{ padding: 5 }} />
                                        </View>
                                        <View style={styles.detailedcallerDetailsContainer}>
