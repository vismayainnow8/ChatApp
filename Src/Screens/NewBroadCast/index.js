...
import {
        Text,
        ScrollView,
        FlatList, Platform, PermissionsAndroid, SafeAreaView, StatusBar, TouchableOpacity,
        Image,
        View,
} from 'react-native';
...
const NewBroadCast = ({ navigation }) => {
        ...
        useLayoutEffect(() => {
                navigation.setOptions({
                        ...
                        headerTitle: (
                                <View>
                                        <Text style={{ fontSize: 15, fontWeight: "bold", color: "white" }}>New BroadCast</Text>
                ...
                <ScrollView style={styles.mainContainer}>
                        ...
                        <View style={styles.contentContainer}>
                                <View style={styles.textContainer}>
                                        <Text style={styles.text}> Only contact with 123456789 in  their address book will recieve your broadcast messages</Text>
                                </View>
                                <FlatList
                                        data={contacts}
